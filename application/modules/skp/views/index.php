                    ...
                    <div class="col-xl-12">
                      <div class="card">
                        <div class="card-header">
                          <h2>Tabel SKP Pegawai</h2>
                          <h6 class="card-subtitle">Tabel digunakan untuk mengubah <code>"daftar skp pegawai"</code> aplikasi MAPEN.
                          </h6>
                          <?php
                                ...
                                <?php foreach ($semuauser as $su) : ?>
                                  <tr>
                                    ...
                                    <td class=" align-middle text-center">
                                      <a class="btn waves-effect waves-light btn-primary text-white" href="<?= base_url('skp/detail/' . $su['user_id']) ?>"> <i class="fa fa-info-circle"></i> Detail</a>
                                    </td>
                                  </tr>
                                <?php endforeach; ?>
                              </tbody>
