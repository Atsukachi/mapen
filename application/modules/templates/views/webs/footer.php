    ...
    <div class="footer-top">
      <div class="container">
        <div class="row gy-4 justify-content-center">
          <div class="col-lg-3 col-md-12 footer-contact text-center align-self-center">
            <h4>Contact Us</h4>
          ...
          <div class="col-lg-5 col-md-12 footer-info">
            ...
            <p>Platform aplikasi sistem informasi manajemen pegawai untuk mengelola kinerja pegawai, input kegiatan harian, serta terdapat presensi kerja saat during maupun luring.</p>
          </div>
