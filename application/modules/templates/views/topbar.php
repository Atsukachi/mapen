            ...
            <div class="navbar-header" data-logobg="skin6">
                ...
                <div class="navbar-brand justify-content-center">
                    ...
                    <a href="<?= base_url() ?>">
                        <b class="logo-icon">
                            <!-- Dark Logo icon -->
                            <img src="<?= base_url('assets/') ?>images/logo-dashboard.png" alt="homepage" class="dark-logo" />
                            <!-- Light Logo icon -->
                            <img src="<?= base_url('assets/') ?>images/logo-dashboard.png" alt="homepage" class="light-logo" />
                        </b>
                        <!--End Logo icon -->
                    </a>
                </div>
                ...
                <ul class="navbar-nav float-right">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img src="<?= base_url('assets/images/users/') . $user['image']; ?>" alt="user" class="rounded-circle" width="40">
                            <span class="ml-2 d-none d-lg-inline-block"><span>Hello,</span> <span class="text-dark"><?= $user['name']; ?></span></span> <i data-feather="chevron-down" class="svg-icon"></i></span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                            ...
                            <a class="dropdown-item" href="javascript:void(0)"><i data-feather="mail" class="svg-icon mr-2 ml-1"></i>
                                Inbox</a> -->
                            <a class="dropdown-item" href="<?= base_url('profil/edit'); ?>"><i data-feather="settings" class="svg-icon mr-2 ml-1"></i>
                                Account Setting</a>
                            <div class="dropdown-divider"></div>
