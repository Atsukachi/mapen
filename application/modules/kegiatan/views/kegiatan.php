                                ...
                                <?php foreach ($semuauser as $su) : ?>
                                  <tr>
                                    ...
                                    <td class=" align-middle text-center">
                                      <a class="btn waves-effect waves-light btn-primary text-white" href="<?= base_url('kegiatan/detail_kegiatan/' . $su['user_id']) ?>"> <i class="fa fa-info-circle"></i> Detail</a>
                                    </td>
                                  </tr>
                                <?php endforeach; ?>
                              </tbody>
